      ...
      <div className="px-6 pt-5 pb-3 border-b border-ink-800">
        ...
        <input
          className="w-full bg-transparent outline-none mt-2 text-[19px]
                     font-display tracking-tight text-ink-100 placeholder:text-ink-700"
          placeholder="Title"
          value={article.title}
        ...
        <input
          className="w-full bg-transparent outline-none mt-1 text-[13px]
                     text-ink-400 placeholder:text-ink-700"
        ...
        <input
          className="w-full bg-transparent outline-none mt-1 text-[11px]
                     uppercase tracking-[0.12em] text-ink-500 placeholder:text-ink-700"
          placeholder="Author"
